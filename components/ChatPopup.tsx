...
export function ChatPopup({ onEmotionChange }: { onEmotionChange?: (emotion: string) => void }) {
  ...
  return (
    <div className="fixed bottom-6 left-6">
      <button
        onClick={() => setOpen((o) => !o)}
        className="w-14 h-14 rounded-full bg-gradient-to-r from-purple-600 to-cyan-400 shadow-glow flex items-center justify-center hover:scale-105 transition"
      >
        <MessageCircle />
      </button>
      {open && (
        <div className="mt-3 w-80 glass-card rounded-2xl p-4 border border-purple-700/60 shadow-glow">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-purple-700 flex items-center justify-center text-white font-semibold">AI</div>
            <div>
              <p className="font-semibold text-sm">Sunny – AI Cố Vấn</p>
